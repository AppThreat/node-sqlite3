...
function install(
    ...
    // applyChangeset resolves nothing (the database is the outcome);
    // serializeToBytes/changeset/patchset resolve the bytes; blob
    // read/write resolve the number of bytes transferred.
