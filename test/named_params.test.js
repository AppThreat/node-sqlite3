...
describe('named parameters', function () {
    ...
    it('should insert a value with $ placeholders', function (_t, done) {
        db.run(
    ...
    it('should insert a value with @ placeholders using an array', function (_t, done) {
        db.run(
            'INSERT INTO foo VALUES(@txt, @id)',
            ['Sed Do Eiusmod', 4],
            done,
    ...
    it('should insert a value with indexed placeholders', function (_t, done) {
        db.run(
    ...
    it('should insert a value with autoindexed placeholders', function (_t, done) {
        db.run(
    ...
    it('should retrieve all inserted values', function (_t, done) {
